                ...
                <div class="team-wrapper mb-30">
                    <div class="team-img">
                        ...
                        <div class="team-action">
                            <a class="facebook" href="https://web.facebook.com/aouffa1">
    ...
    <div class="container">
        <div class="brand-logo-active owl-carousel">
            <div class="single-brand-logo">
                <img src="{{asset('front/assets/img/brand-logo/barnd-logo-1.png')}}" alt="">
            </div>
            <div class="single-brand-logo">
                <img src="{{asset('front/assets/img/brand-logo/barnd-logo-2.png')}}" alt="">
            </div>
            <div class="single-brand-logo">
                <img src="{{asset('front/assets/img/brand-logo/barnd-logo-3.png')}}" alt="">
            </div>
            <div class="single-brand-logo">
                <img src="{{asset('front/assets/img/brand-logo/barnd-logo-4.png')}}" alt="">
            </div>
            <div class="single-brand-logo">
                <img src="{{asset('front/assets/img/brand-logo/barnd-logo-5.png')}}" alt="">
            </div>
        </div>
    </div>
</div>
