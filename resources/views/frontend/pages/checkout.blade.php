                ...
                <div class="billing-info-wrap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2">
                            <div class="billing-info mb-20">
                                <label>&nbsp;</label>
                                <button id="toggle-add-new-address" class="btn btn-primary form-control"><span class="fa fa-angle-up"></span></button>
                                <input type="hidden" id="add-new-address-is-active" value="0">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input type="text" class="form-control" id="search-address" placeholder="Search for address">
                                        <input class="map-searchbox hidden" id="pac-input" name="" type="text" value="">
                                    </div>
                                </div>
    ...
    <script>
        ...
        function initAutocomplete() {
            var map = new google.maps.Map(document.getElementById('map'), {
                center: {
                    lat: {{ SITE_ADDRESS_LAT }},
                    lng: {{ SITE_ADDRESS_LNG }}
                },
                zoom: 15,
                mapTypeId: 'roadmap'
            });
